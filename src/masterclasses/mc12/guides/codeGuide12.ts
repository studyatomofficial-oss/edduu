...
export const codeGuide12: GuideDefinition = {
  type: 'code',
  title: 'MC12 Code Guide',
  label: 'MC12 Code Guide',
  objective:
...
CMD ["uvicorn", "app.main:app", "--host", "0.0.0.0", "--port", "8000"]`,
...

    {
      ...
      code: `CREATE TABLE learning_events_2026 PARTITION OF learning_events;`,
      details: [
...
output "environment_name" {
  value = var.environment
...

    {
      ...
      code: `kubectl get pods -l app=edduu-api`,
      details: [
        'Run terraform plan.',
...
SLO:
  99.9% successful requests over the measurement window`,
...

    {
      ...
      code: `kubectl get deployment,service,hpa -n edduu`,
      details: [
